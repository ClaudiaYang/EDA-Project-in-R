...
The CCD includes a broad array of variables, totaling 99, ranging from graduation rates and standardized test scores to teacher qualifications and student-teacher ratios. While this wealth of data offers a broad lens to view the educational landscape, for our specific inquiry into educational inequalities, many of these variables are peripheral. Therefore, to deepen our analysis and maintain clarity in our investigation, we have chosen to focus on a subset of variables that directly relate to academic outcomes and socio-economic factors, such as demographics, test scores, academic achievements, and family income.
